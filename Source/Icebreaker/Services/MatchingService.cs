                ...
                foreach (var team in teams)
                {
                    ...
                    try
                    {
                        ...
                        foreach (var pair in this.MakePairs(optedInUsers, pastPairs).Take(this.maxPairUpsPerTeam))
                        {
                            ...
                            var profile1 = dbMembersProfile.ContainsKey(pair.Item1.Id) ? dbMembersProfile[pair.Item1.Id] : null;
                            var profile2 = dbMembersProfile.ContainsKey(pair.Item2.Id) ? dbMembersProfile[pair.Item2.Id] : null;
